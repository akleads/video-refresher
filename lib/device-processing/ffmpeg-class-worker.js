/**
 * Self-hosted FFmpeg.wasm class worker (from @ffmpeg/ffmpeg@0.12.15)
 * Inlined const.js and errors.js to avoid cross-origin import issues.
 * Same-origin hosting allows blob URL access for core files under COEP require-corp.
 */

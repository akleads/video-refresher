...
async function initFFmpeg() {
  try {
    ...
    // Convert FFmpeg class worker to blob URL (COEP blocks cross-origin Workers)
    ...
    try {
      ...
      // Fresh instance for fallback (can't reuse after failed load)
      ffmpeg = new FFmpeg();

...
Output: All 5 files updated to accept, validate, and correctly process MOV files in both device and server modes.
</objective>
...
<task type="auto">
  ...
  <files>server/lib/processor.js, server/routes/jobs.js, lib/device-processing/ffmpeg-worker.js</files>
  <action>
**server/lib/processor.js:**
